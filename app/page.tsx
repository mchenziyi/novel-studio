...
import { StylePanel } from '@/components/settings/style-panel';
      ...
      <div className="max-w-6xl mx-auto px-8 py-12">
        ...
        <div className="bg-white rounded-2xl border border-[#e8e8e8] p-6 mb-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-9 h-9 rounded-lg bg-[#f5f5f5] flex items-center justify-center">
              <svg className="w-4.5 h-4.5 text-[#525252]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
            </div>
            <div>
              <h2 className="text-[15px] font-medium text-[#171717]">写作规范</h2>
              <p className="text-[12px] text-[#a3a3a3]">当前小说的写作要求，AI 对话时会自动遵循</p>
            </div>
          </div>
          <NovelConfigPanel />
        </div>
        ...
        <div className="bg-white rounded-2xl border border-[#e8e8e8] p-6 mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-[15px] font-medium text-[#171717]">文风仿写</h2>
              <p className="text-[12px] text-[#a3a3a3]">导入参考文本的写作风格，AI 写作时自动模仿</p>
            </div>
          </div>
          <StylePanel />
        </div>
